...
import { FaTrophy, FaIndustry, FaCubes, FaChevronRight, FaClock } from 'react-icons/fa';
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden h-64">
        ...
        />
        <div className="absolute top-4 right-4 bg-[#CE171F] text-white px-3 py-1 rounded-full text-sm font-semibold z-20">
          Vonic Systems
        </div>
      </div>
      ...
      <div className="p-6 flex-grow flex flex-col">
        ...
        <div className="mt-auto space-y-3">
          ...
          <div className="flex items-start">
            <FaClock className="text-[#CE171F] mt-1 mr-2 flex-shrink-0" />
            <p className="text-sm text-gray-700">{cycle}</p>
          </div>
        </div>
      </div>
  ...
  const projects = [
    {
      id: 1,
      image: project16Img,
      title: t('sections.projects.cases.16_channels.title'),
      description: t('sections.projects.cases.16_channels.description'),
      industries: t('sections.projects.cases.16_channels.industries'),
      materials: t('sections.projects.cases.16_channels.materials'),
      cycle: t('sections.projects.cases.16_channels.cycle')
    },
    {
      id: 2,
      image: project24Img,
      ...
      cycle: t('sections.projects.cases.24_channels.cycle')
    },
    {
      id: 3,
      image: project32Img,
      title: t('sections.projects.cases.32_channels.title'),
      description: t('sections.projects.cases.32_channels.description'),
      industries: t('sections.projects.cases.32_channels.industries'),
      materials: t('sections.projects.cases.32_channels.materials'),
      cycle: t('sections.projects.cases.32_channels.cycle')
    },
    {
      id: 4,
      image: project64Img,
      ...
      cycle: t('sections.projects.cases.64_channels.cycle')
    },
  ];
