    ...
    <section className="py-16 bg-gradient-to-b from-black to-gray-900 relative" id="parceiros">
      ...
      <div className="container mx-auto px-6 mb-16 relative z-20">
        ...
        >
          <div className="inline-flex items-center justify-center mb-5 bg-black/60 backdrop-blur-md px-4 py-2 rounded-full border border-white/10 shadow-lg">
            ...
            <span className="text-white/90 text-sm font-medium">{t('sections.partners.title')}</span>
          </div>
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-stretch">
          ...
          {/* Left Side - Modern card layout - 7 columns */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          {/* Right Side - Image with professional treatment - 5 columns */}
          <motion.div
