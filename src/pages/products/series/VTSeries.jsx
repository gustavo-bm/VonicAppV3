...
const VTSeries = () => {
  const specifications = [
    { name: "Diâmetro do Bico", value: "16mm - 24mm" },
    { name: "Comprimento", value: "50mm - 350mm" },
    { name: "Potência", value: "200W - 1500W" },
    { name: "Temperatura Máxima", value: "350°C" },
    { name: "Material do Corpo", value: "Aço H13" },
    { name: "Material da Ponta", value: "Aço H13 com Tratamento Térmico" },
    { name: "Pressão Máxima de Injeção", value: "1800 bar" },
    { name: "Controle de Temperatura", value: "Termopar tipo J" }
  ];
  ...
  const documents = [
    {
      ...
      description: "Manual completo de instalação e operação da série VT",
      downloadUrl: "/docs/vt-series-manual.pdf"
    },
    {
      icon: FaFileAlt,
      title: "Especificações Técnicas",
      description: "Documento detalhado com todas as especificações técnicas",
      downloadUrl: "/docs/vt-series-specs.pdf"
    },
    {
      icon: FaFileVideo,
      title: "Guia de Manutenção",
      description: "Vídeo tutorial de manutenção preventiva",
      downloadUrl: "/docs/vt-series-maintenance.mp4"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-vonic-dark pt-24">
      <div className="container mx-auto px-4 py-12">
        ...
        >
          <h1 className="text-5xl font-bold mb-6 text-white">Série VT</h1>
          <p className="text-xl text-white/90 max-w-3xl mx-auto">
            Bicos térmicos para aplicações gerais com excelente distribuição térmica
          </p>
        </motion.div>
          ...
          >
            ...
            <ul className="space-y-4 text-white/80">
              <li className="flex items-start">
                ...
                <p>Perfil térmico otimizado para melhor distribuição de temperatura</p>
              </li>
              <li className="flex items-start">
                <span className="w-2 h-2 bg-[#CE171F] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <p>Múltiplas opções de pontas para diferentes aplicações</p>
              </li>
              <li className="flex items-start">
                <span className="w-2 h-2 bg-[#CE171F] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <p>Design robusto para maior durabilidade</p>
              </li>
              <li className="flex items-start">
                <span className="w-2 h-2 bg-[#CE171F] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <p>Ideal para processamento de materiais comuns</p>
              </li>
            </ul>
