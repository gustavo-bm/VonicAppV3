...
const VHSeries = () => {
  const specifications = [
    { name: "Diâmetro do Bico", value: "18mm - 27mm" },
    { name: "Comprimento", value: "60mm - 380mm" },
    { name: "Potência", value: "250W - 2000W" },
    { name: "Temperatura Máxima", value: "400°C" },
    { name: "Material do Corpo", value: "Aço H13" },
    { name: "Material da Ponta", value: "Aço H13 Nitretado" },
    { name: "Pressão Máxima de Injeção", value: "2000 bar" },
  ...
  const documents = [
    {
      ...
      description: "Manual completo de instalação e operação da série VH",
  ...
  return (
    <div className="min-h-screen bg-gradient-vonic-dark pt-24">
      <div className="container mx-auto px-4 py-12">
        ...
        >
          <h1 className="text-5xl font-bold mb-6 text-white">Série VH</h1>
          <p className="text-xl text-white/90 max-w-3xl mx-auto">
            Bicos de válvula de alta performance para aplicações exigentes
          </p>
        </motion.div>
          ...
          >
            ...
            <ul className="space-y-4 text-white/80">
              <li className="flex items-start">
                ...
                <p>Sistema de vedação avançado que previne vazamentos e garante máxima eficiência</p>
              </li>
              <li className="flex items-start">
                <span className="w-2 h-2 bg-[#CE171F] rounded-full mt-2 mr-3 flex-shrink-0"></span>
              ...
              <li className="flex items-start">
                <span className="w-2 h-2 bg-[#CE171F] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <p>Design modular para fácil manutenção e troca de componentes</p>
              </li>
              <li className="flex items-start">
                <span className="w-2 h-2 bg-[#CE171F] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <p>Compatível com uma ampla gama de materiais e aplicações</p>
              </li>
            </ul>
